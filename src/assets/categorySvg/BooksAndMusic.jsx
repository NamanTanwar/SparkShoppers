...
const BooksAndMusicSvg=({fill,height,width})=>{
    return (
...
const BooksAndMusic=({fill,height,width,border})=>{
    return (
        <div className="flex flex-col space-y-2 items-center p-3">
                    <div className={` border-${border} border-2 rounded-md p-3`}>
                        <BooksAndMusicSvg height={height} width={width} fill={fill}/>
                    </div>
                    <p className="font-bold">Books And Music</p>
                </div>
    )
}
