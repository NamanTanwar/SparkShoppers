...
const FurnitureSvg=({height,width})=>{
    return (

        <svg width={width} height={height} viewBox="-15.81 0 123.38 123.38" version="1.1" id="Layer_1" fillRule='evenodd' clipRule="evenodd" stroke='#000000' strokeWidth={0.5} strokeMiterlimit={2.6131}>
    ...
    return (
        <div className="flex flex-col space-y-2 items-center p-3">
                    <div className=" border-black border-2 rounded-md p-3">
                        <FurnitureSvg height={"70px"} width={"70px"}/>
                    </div>
