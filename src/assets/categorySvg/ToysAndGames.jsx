...
const ToysAndGamesSvg=({height,width,fill})=>{
	return (
		<svg version="1.1" id="Icons" height={height} width={width} viewBox="0 0 32 32" fill={fill} stroke='#000000' strokeWidth={2} strokeLinecap='round' strokeLinejoin='round' strokeMiterlimit={10}>
