    ...
    <form onSubmit={handleSubmit}>
      <div className="rating-review-card flex flex-col bg-gray-100 rounded-lg shadow-lg p-6 max-w-lg mx-auto my-8">
        ...
        <div className="flex justify-end mt-4">
          <button
            type="submit"
            className="submit-button bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 ease-in-out"
          >
            Submit
          </button>
        </div>
