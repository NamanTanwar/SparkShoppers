...
const OrdersTab=({ordersTabData})=>{
    
    const percentageIncOrDec=Math.round(((ordersTabData.currentMonthAvg-ordersTabData.lastMonthAvg)/ordersTabData.lastMonthAvg)*100*10)/10
    
    return (
        <div className='flex flex-col p-4 bg-white rounded shadow-md'>

            <div className='flex flex-row items-center mb-2'>
                <FiShoppingBag size={24} className='text-gray-500 mr-2'/>
