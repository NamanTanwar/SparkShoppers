...
const FeatureSection=()=>{
    return (
        <div className="flex flex-col md:flex-row space-x-4 md:space-y-6 mt-12 items-center justify-center">

            

            <div className="relative bg-green-300 flex flex-col justify-start items-center ml-16 pt-8 pb-5 pl-2 pr-2 hover:bg-green-400 w-64 h-40">
            ...
            <div className="relative bg-yellow-300 flex flex-col justify-center items-center pt-8 pb-5 pl-2 pr-2 hover:bg-yellow-400 w-64 h-40">
                <div className="absolute top-0 left-14 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className="relative bg-blue-300 flex flex-col justify-center items-center pt-8 pb-5 mr-16 pl-2 pr-2 hover:bg-blue-400 w-64 h-40">
                <div className="absolute top-0 left-14 transform -translate-x-1/2 -translate-y-1/2">
