                ...
                filteredReviews.map((ratingAndReview,idx)=>(
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-row'>
                            <img src={`https://api.dicebear.com/8.x/initials/svg?seed=${ratingAndReview.user.firstname}`} alt='User profile img'/>
                            <p>{ratingAndReview.user.firstname} {ratingAndReview.user.lastname}</p>
                        </div>
                        <div>
                         <RatingStars avgRating={ratingAndReview.rating} starSize={10}/>
