...
//route for fetching super category page data
router.post(
  "/getSuperCategoryPageData",
  validate(getSuperCategoryPageData),
  pagination,
  categoryController.getSuperCategoryPageData
);

router.post(
  "/getSuperCategoryCategoryData",
  validate(getSuperCategoryCategoryData),
  pagination,
  categoryController.getSuperCategoryCategoryData
);

router.post(
  "/:superCategoryName/:brandName",
  validate(getSuperCategoryBrandData),
  pagination,
  categoryController.getSuperCategoryBrandData
);
